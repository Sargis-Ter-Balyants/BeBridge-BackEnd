...
export class UserController {
    ...
    account(@Req() req: RequestWithUser, @Body() account: ProfileDto, @UploadedFile() avatar: Express.Multer.File) {
    ...
    @UseGuards(AuthGuard)
    @Patch("bookmark/:id")
    bookmark(@Req() req: RequestWithUser, @Param("id") id: string) {
        return this.userService.bookmark(req.user, new Types.ObjectId(id));
    }
