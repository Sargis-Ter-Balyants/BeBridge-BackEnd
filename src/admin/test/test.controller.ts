...
export class TestController {
    ...
    @Roles(Role.MODERATOR, Role.EMPLOYER)
    @Patch(":id")
    update(@Req() req: Request, @Param("id", ParseObjectId) id: Types.ObjectId, @Body() updateTestDto: UpdateTestDto) {
    ...
    @Roles(Role.MODERATOR, Role.EMPLOYER)
    @Delete(":id")
    remove(@Req() req: Request, @Param("id", ParseObjectId) id: Types.ObjectId) {
